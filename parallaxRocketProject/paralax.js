/* 
    ...
    Makes different layers of content/backgrounds move at different speeds when the webpage is scrolled
    this creates the illusion of Three-Dimensional Depth.

    perspective changes the relative speed of objects 
    we have multiple images that scroll at different speeds 
...
window.onload = function() {
  ...
  window.addEventListener('scroll', function(e) {
    ...
    /* identifies an object in the same way that a name or variable does Ex. ${z_1} is refering to that variable */
